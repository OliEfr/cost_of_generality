"""MDP terms for push_target. Star-imports isaaclab base mdp, then task terms."""

from isaaclab.envs.mdp import *  # noqa: F401,F403

# Reused generic helpers (same set cup_place and drawer_stow verified against stack):
