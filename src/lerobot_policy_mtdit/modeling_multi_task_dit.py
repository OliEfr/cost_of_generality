...
# Backport delta vs the 0.5.2 checkout (commit fc6c94c): 0.4.4's import_utils has
# _transformers_available but not _diffusers_available / require_package — those two
# come from the in-package compat shim. Relative ..pretrained / ..utils imports are
# rewritten absolute because this package lives outside the lerobot tree.
from lerobot.utils.import_utils import _transformers_available

from ._compat import _diffusers_available, require_package
