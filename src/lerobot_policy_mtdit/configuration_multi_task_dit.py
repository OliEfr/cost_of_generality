...
# Backported into cost_of_generality from the lerobot 0.5.2 checkout at
# /home/admin_07/project_repos/lerobot_AICchallange/lerobot (commit fc6c94c),
# src/lerobot/policies/multi_task_dit/configuration_multi_task_dit.py.
# Module name kept VERBATIM: 0.4.4's factory resolves modeling/processor modules by
# config_cls.__module__.replace("configuration_", ...) (factory.py:531-590).
# Delta vs upstream: import paths only — 0.4.4 has no lerobot.configs / lerobot.optim
# package-level re-exports, so import from the defining modules instead.
